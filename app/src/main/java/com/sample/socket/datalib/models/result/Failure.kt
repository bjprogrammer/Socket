...
import com.sample.socket.datalib.models.result.Failure.FeatureFailure

/**
 * Base Class for handling errors/failures/exceptions.
 * Every feature specific failure should extend [FeatureFailure] class.
 */
sealed class Failure(open val title: String, open val msg: String, open val reason: Throwable?) :
    Throwable(msg, reason) {
    ...
    object NetworkConnection :
        Failure("Something went wrong!", "Please check your Internet Connection")

    object TimeOutError :
        Failure("Something went wrong!", "Please stay with us, while we fix it.", null)

    class Default : Failure {

package com.sample.socket.base.activities
 ...
 */
abstract class BaseAndroidDataFlowViewModelActivity<VB : ViewDataBinding, VM : AndroidDataFlow>(
    ...
    open fun VB.initListeners(vm : VM){}
